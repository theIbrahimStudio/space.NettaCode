...
const HomePage = () => {
  ...
  return (
    <Fragment>
      <SEO title="Home - Netta Code Indonesia" description="Grow your business with the support of our information system, enjoy doing business with all the ease and efficiency of using the system. Monitoring your business anywhere and anytime." />
      <Page pageid="nettacode-home">
        ...
        {/* <Container>
          <Section gap="0.625em">
            <SectionMarker>BLOG</SectionMarker>
            <Section gap="0.3125em">
              <H1 size="1.5625em" color="inherit" whiteSpace="pre-line">
                News & Updates
              </H1>
        ...
        <Container>
          <Section direction="row" isWrap>
            <Section flex="1" minWidth="25em" minHeight="18.75em">
              <Section justifyContent="center" alignItems="flex-start" flex="1" zIndex="2" padding="1.875em" gap="1.2em" color="var(--color-secondary)">
                <SectionMarker>TRIAL</SectionMarker>
                <Section gap="0">
                  <H1 color="inherit" size="1.5625em">
              ...
              <div className={`${styles.folder} ${styles.leftLine}`} style={{ zIndex: "1", height: "100%" }}></div>
              <div className={`${styles.folder} ${styles.left}`} style={{ height: "100%" }}></div>
            </Section>
            <Section flex="1" minWidth="25em" minHeight="18.75em">
              <Section justifyContent="center" alignItems="flex-start" flex="1" zIndex="2" padding="1.875em" gap="1.2em" color="var(--color-secondary)">
                <SectionMarker>FOLLOW</SectionMarker>
                <H1 color="inherit" size="1.5625em">
                  Instagram
                </H1>
                <Section padding="0" gap="0" cwidth="100%" cheight="7.5rem" justifyContent="center">
                  <Img style={{ height: "auto", width: "100%" }} src="/img/features.jpg" />
                </Section>
                <P color="inherit" size="1em">
                  @nettacodeindonesia
                </P>
